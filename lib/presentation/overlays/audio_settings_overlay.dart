        ...
        child: Column(
          ...
          children: [
            ...
            VolumeSlider(
              ...
              onChanged: (value) {
                audioSettingsNotifier.setMusicVolume(value);
              },
              icon: Icons.music_note,
              isMuted: audioSettings.isMusicMuted,
              onMutePressed: () {
                audioSettingsNotifier.toggleMusicMute();
              },
            ),
            ...
            VolumeSlider(
              ...
              onChanged: (value) {
                audioSettingsNotifier.setSfxVolume(value);
              },
              icon: Icons.volume_up,
              isMuted: audioSettings.isSfxMuted,
              onMutePressed: () {
                audioSettingsNotifier.toggleSfxMute();
              },
            ),
          ],
        ),
